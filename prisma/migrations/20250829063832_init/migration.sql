...
-- CreateEnum
CREATE TYPE "public"."ApplicationStatus" AS ENUM ('APPLIED', 'SHORTLISTED', 'REJECTED', 'HIRED', 'WITHDRAWN');

-- CreateEnum
CREATE TYPE "public"."QuestionType" AS ENUM ('SINGLE_CHOICE', 'MULTIPLE_CHOICE', 'SHORT_ANSWER');

-- CreateEnum
CREATE TYPE "public"."JobApplicationSource" AS ENUM ('DIRECT', 'EXTERNAL', 'PRE_SCREENING');

-- CreateEnum
CREATE TYPE "public"."JobPriority" AS ENUM ('REGULAR', 'FEATURED', 'URGENT');

-- CreateEnum
CREATE TYPE "public"."ProficiencyLevel" AS ENUM ('BEGINNER', 'INTERMEDIATE', 'ADVANCED');
...
CREATE TABLE "public"."JobSeekerSkill" (
    ...
    "proficiencyLevel" "public"."ProficiencyLevel",
...
CREATE TABLE "public"."JobApplication" (
    ...
    "source" "public"."JobApplicationSource" NOT NULL,
    "coverLetter" TEXT,
    "withdrawnAt" TIMESTAMP(3),
    "priority" "public"."JobPriority" NOT NULL DEFAULT 'REGULAR',
    "notes" TEXT,
...
-- CreateTable
CREATE TABLE "public"."JobApplicationAnswer" (
    "id" BIGINT NOT NULL DEFAULT floor(random()*1000000000+1000000000),
...
-- CreateIndex
CREATE UNIQUE INDEX "JobApplication_uniqueKey_key" ON "public"."JobApplication"("uniqueKey");

-- CreateIndex
CREATE INDEX "JobApplication_jobId_status_idx" ON "public"."JobApplication"("jobId", "status");

-- CreateIndex
CREATE INDEX "JobApplication_jobSeekerId_status_idx" ON "public"."JobApplication"("jobSeekerId", "status");

-- CreateIndex
CREATE INDEX "JobApplication_appliedAt_idx" ON "public"."JobApplication"("appliedAt");

-- CreateIndex
CREATE INDEX "JobApplication_priority_idx" ON "public"."JobApplication"("priority");
...
-- AddForeignKey
ALTER TABLE "public"."JobApplication" ADD CONSTRAINT "JobApplication_jobSeekerId_fkey" FOREIGN KEY ("jobSeekerId") REFERENCES "public"."JobSeeker"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."JobApplication" ADD CONSTRAINT "JobApplication_resumeId_fkey" FOREIGN KEY ("resumeId") REFERENCES "public"."JobSeekerResume"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."JobApplicationAnswer" ADD CONSTRAINT "JobApplicationAnswer_applicationId_fkey" FOREIGN KEY ("applicationId") REFERENCES "public"."JobApplication"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."JobApplicationAnswer" ADD CONSTRAINT "JobApplicationAnswer_questionId_fkey" FOREIGN KEY ("questionId") REFERENCES "public"."ScreeningQuestion"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
